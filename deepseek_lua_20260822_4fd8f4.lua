-- Achaotic UI - Roblox Lua Script (Fixed & Resizable)
...
status.Name = "Status"
status.Size = UDim2.new(0, 150, 0, 26)
status.Position = UDim2.new(1, -160, 0.5, -13)
...
parryCard.Size = UDim2.new(1, 0, 0, 140)
...
statusTag.Size = UDim2.new(0, 50, 0, 18)
statusTag.Position = UDim2.new(1, -58, 0, 9)
...
function createToggle(parent, y, label, subLabel, defaultValue)
    ...
    toggle.MouseButton1Click:Connect(function()
        ...
        -- Update status tag if it's the main toggle
...
-- Function to create chip labels
function createChip(parent, x, y, text, active)
    local chip = Instance.new("TextLabel")
    chip.Size = UDim2.new(0, #text * 8 + 16, 0, 20)
...
createChip(detectRow, 70, 2, "Death Slash")
createChip(detectRow, 145, 2, "Time Hole")

-- Lobby Auto Parry
createToggle(parryCard, 116, "Lobby Auto Parry", "Enabled", true)

-- Spam Card
local spamCard = Instance.new("Frame")
spamCard.Name = "SpamCard"
spamCard.Size = UDim2.new(1, 0, 0, 135)
spamCard.Position = UDim2.new(0, 0, 0, 148)
...
-- Add spam toggle
local spamToggle = createToggle(spamCard, 34, "Spam Parry", "BETA", true)
...
-- Manual spam toggle
local manualToggle = createToggle(spamCard, 90, "Manual Spam", "Active", true)

-- Manual chips
local manualChips = Instance.new("Frame")
manualChips.Size = UDim2.new(1, -16, 0, 24)
manualChips.Position = UDim2.new(0, 8, 0, 112)
...
blockText.Size = UDim2.new(0, 40, 1, 0)
...
blockKey.Position = UDim2.new(0, 45, 0.5, -10)
...
abilityText.Size = UDim2.new(0, 45, 1, 0)
abilityText.Position = UDim2.new(0, 80, 0, 0)
...
abilityKey.Position = UDim2.new(0, 130, 0.5, -10)
